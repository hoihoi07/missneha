...
class GoogleDriveHelper:
    ...
    def upload_file(self, file_path, file_name, mime_type, parent_id):
        ...
        file_metadata = {
            'name': file_name,
            'description': 'Uᴘʟᴏᴀᴅᴇᴅ Bʏ @EmpireMirror',
            'mimeType': mime_type,
        }
        try:
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    ...
                    buttons.buildbutton("☁️ Dʀɪᴠᴇ Lɪɴᴋ ☁️", durl)
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        buttons.buildbutton("💡 Iɴᴅᴇx ʟɪɴᴋ 💡", url)
            else:
                ...
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        if VIEW_LINK:
                            buttons.buildbutton("📖 Vɪᴇᴡ Lɪɴᴋ 📖", urls)
    ...
    def create_directory(self, directory_name, parent_id):
        ...
        LOGGER.info("♻️ Cʀᴇᴀᴛᴇᴅ G-Dʀɪᴠᴇ Fᴏʟᴅᴇʀ:\nName: {}\nID: {} ".format(file.get("name"), file_id))
        return file_id
    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            ...
            Telegraph(access_token=telegraph_token).edit_page(path = self.path[prev_page],
                                 title = '💞 Tᴇᴀᴍ Eᴍᴘɪʀᴇ',
                                 author_name='💓 Eᴍᴘɪʀᴇ Mɪʀʀᴏʀ',
                                 author_url='https://t.me/empiremirror',
    ...
    def drive_list(self, fileName, stopDup=False, noMulti=False):
        ...
        for index, parent_id in enumerate(DRIVES_IDS):
            ...
            if not response["files"] and noMulti:
                ...
                continue
            if not Title:
                msg += f'<h4>✅ Sᴇᴀʀᴄʜ Rᴇsᴜʟᴛ Fᴏʀ: {fileName}</h4><br><br>'
                Title = True
            ...
            for file in response.get('files', []):
                if file.get('mimeType') == "application/vnd.google-apps.folder":
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        msg += f"<b><a href={sfurl}>☁️ Dʀɪᴠᴇ Lɪɴᴋ ☁</a></b>"
                    else:
                        msg += f"<b><a href={furl}>☁️ Dʀɪᴠᴇ Lɪɴᴋ ☁</a></b>"
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        sfurl = short_url(furl)
                        msg += f"<b><a href={sfurl}>☁️ Dʀɪᴠᴇ Lɪɴɴᴋ ☁</a></b>"
                    else:
                        msg += f"<b><a href={furl}>☁️ Dʀɪᴠᴇ Lɪɴᴋ ☁️</a></b>"
                    if INDEX_URLS[index] is not None:
                        if RECURSIVE_SEARCH:
                            url_path = "/".join(
        ...
        for content in self.telegraph_content :
            self.path.append(Telegraph(access_token=telegraph_token).create_page(
                                                    title = '💞 Tᴇᴀᴍ Eᴍᴘɪʀᴇ',
                                                    author_name='💓 EᴍᴘɪʀᴇMɪʀʀᴏʀ',
                                                    author_url='https://t.me/theempiregroup',
                                                    html_content=content
                                                    )['path'])
        ...
        msg = f"<b>✅ Foᴜɴᴅ<code>{all_contents_count}</code> results for <code>{fileName}</code></b>"
        buttons = button_build.ButtonMaker()
        buttons.buildbutton("🔎 Vɪᴇᴡ", f"https://telegra.ph/{self.path[0]}")
    ...
    def count(self, link):
        try:
            ...
            msg = "📛 Gᴏᴏɢʟᴇ Dʀɪᴠᴇ ID ᴄᴏᴜʟᴅ ɴᴏᴛ ʙᴇ ғᴏᴜɴᴅ ɪɴ ᴛʜᴇ ᴘʀᴏᴠɪᴅᴇᴅ ʟɪɴᴋ"
            return msg
        msg = ""
        LOGGER.info(f"File ID: {file_id}")
        try:
    ...
    def cancel_download(self):
        ...
        if self.is_downloading:
            LOGGER.info(f"❌ Cᴀɴᴄᴇʟʟɪɴɢ Dᴏᴡɴʟᴏᴀᴅ: {self.name}")
            self.__listener.onDownloadError('Dᴏᴡɴʟᴏᴀᴅ sᴛᴏᴘᴘᴇᴅ ʙʏ ᴜsᴇʀ!')
        elif self.is_cloning:
            LOGGER.info(f"❌ Cᴀɴᴄᴇʟʟɪɴɢ Cʟᴏɴᴇ: {self.name}")
        elif self.is_uploading:
            LOGGER.info(f"❌ Cᴀɴᴄᴇʟʟɪɴɢ Uᴘʟᴏᴀᴅ: {self.name}")
            self.__listener.onUploadError('Yᴏᴜʀ ᴜᴘʟᴏᴀᴅ ʜᴀs ʙᴇᴇɴ sᴛᴏᴘᴘᴇᴅ ᴀɴᴅ ᴜᴘʟᴏᴀᴅᴇᴅ ᴅᴀᴛᴀ ʜᴀs ʙᴇᴇɴ ᴅᴇʟᴇᴛᴇᴅ!')
